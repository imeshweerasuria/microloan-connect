   ...
   <div style={styles.page}>
     ...
     <div style={styles.statsRow}>
       <div style={styles.statCard}>
         ...
         <p style={styles.big}>{stats.submittedLoans}</p>
       </div>
       <div style={styles.statCard}>
         <h3>Total Transactions</h3>
         <p style={styles.big}>{stats.totalTransactions}</p>
       </div>
       <div style={styles.statCard}>
         <h3>Confirmed Transactions</h3>
         <p style={styles.big}>{stats.confirmedTransactions}</p>
       </div>
     </div>

     <div style={{ marginBottom: "16px", display: "flex", gap: "12px", flexWrap: "wrap" }}>
       <Link to="/admin/analytics" style={styles.linkBtn}>Open Analytics</Link>
       <Link to="/repayments" style={styles.linkBtnDark}>Manage Repayments</Link>
     </div>
